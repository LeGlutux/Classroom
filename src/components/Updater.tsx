    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="text-xl text-center font-bold mx-2">
                    Votre version de Thòt Note n'est pas à jour{' '}
                </div>

                <div className="text-sm text-center mx-2 mt-4">
                ...
                <div className="flex flex-col h-40 justify-around mt-12 items-center">
                    <button
                        className="bg-green-700 rounded-lg font-bold w-32 h-12 lg:w-32 lg:h-12 xl:w-40 xl:h-16 shadow-xl font-studentName sm:text-lg md:text-xl lg:text-2xl xl:text-3xl"
                        onClick={() => {
                            onConfirmUpdate()
