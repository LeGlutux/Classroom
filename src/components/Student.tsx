        ...
        <div className="bg-gray-200 rounded flex justify-between w-full my-1">
            <div className="flex flex-col">
                <div className="flex flex-col lg:flex-row xl:flex:row mt-2">
                    <div className="ml-2 text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-gray-900 font-medium h-5">
                        {props.name}
                    </div>
                    <div
                        
                        className="font-studentName ml-2 text-2xl md:text-3xl lg:text-4xl xl:text-5xl lg:ml-4 mt-1 md:mt-2 lg:mt-0 xl:mt-0 xl:ml-4 text-2xl text-gray-900 font-medium font-bold overflow-hidden"
                    >
                        {props.surname}
                    </div>
                </div>
                <div className="text-xs text-gray-600 flex flex-row ml-2 mt-4 md:mt-2 md:mb-2">
                    <div className="flex flex-row align-baseline">
                        <img className="mt-2 w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 xl:w-12 xl:h-12 md:ml-1 lg:ml-2 xl:ml-4" src={alarm} alt="" />{' '}
                        <div className="font-bold text-black h-4 w-4 flex text-2xl md:text-3xl lg:text-4xl xl:text-5xl ">
                            {behaviour}
                        </div>
                    </div>{' '}
                    <div className="flex flex-row align-baseline">
                        <img className="mt-2 w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 xl:w-12 xl:h-12 md:ml-1 lg:ml-2 xl:ml-4" src={bookPile} alt="" />{' '}
                        <div className="font-bold text-black h-4 w-4 flex text-2xl md:text-3xl lg:text-4xl xl:text-5xl ">
                            {homework}
                        </div>
                    </div>{' '}
                    <div className="flex flex-row align-baseline">
                        <img className="mt-2 w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 xl:w-12 xl:h-12 md:ml-1 lg:ml-2 xl:ml-4" src={schoolBag} alt="" />{' '}
                        <div className="font-bold text-black h-4 w-4 flex text-2xl md:text-3xl lg:text-4xl xl:text-5xl ">
                            {supply}
                        </div>
                    </div>{' '}
                    <div className="flex flex-row align-baseline">
                        <img className="mt-2 w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 xl:w-12 xl:h-12 md:ml-1 lg:ml-2 xl:ml-4" src={pen} alt="" />{' '}
                        <div className="font-bold text-black h-4 w-4 flex text-2xl md:text-3xl lg:text-4xl xl:text-5xl ">
                            {observation}
                        </div>
                    </div>{' '}
            ...
            <div className=" w-32 h-32 lg:w-1/2 xl:w-1/2 md:w-2/5 flex justify-around items-center content-around flex-wrap p-2 xl:mt-3">
                ...
                >
                    <img className="md:w-16 md:h-16 md:p-1 lg:w-16 lg:h-16 lg:mx-2 xl:w-20 xl:h-20 xl:mx-4" src={alarm} alt="" />
                </button>
                <button
                ...
                >
                    <img className="md:w-16 md:h-16 md:p-1 lg:w-16 lg:h-16 lg:mx-2 xl:w-20 xl:h-20 xl:mx-4" src={bookPile} alt="" />
                </button>
                <button
                ...
                >
                    {' '}
                    <img className="md:w-16 md:h-16 md:p-1 lg:w-16 lg:h-16 lg:mx-2 xl:w-20 xl:h-20 xl:mx-4" src={schoolBag} alt="" />
                </button>
                <button
                ...
                >
                    <img className="md:w-16 md:h-16 md:p-1 lg:w-16 lg:h-16 lg:mx-2 xl:w-20 xl:h-20 xl:mx-4" src={pen} alt="" />
                </button>
            </div>
        </div>
    )
