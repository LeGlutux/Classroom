...
{displayedGroup !== 'tous' &&
            ...
            {displayedGroup === 'tous' &&
            <div className="flex w-full h-full flex-col bg-white overflow-y-scroll justify-around md:flex-row md:flex-wrap md:content-start lg:flex-row lg:flex-wrap lg:content-start xl:flex-row xl:flex-wrap xl:content-start">
                {
                    <HomeClassListFilter
